...
function Footer() {
  ...
  return (
    <footer className="text-center lg:text-left bg-black-black text-gray-600">
  ...
  <div className="mx-6 py-10 text-center md:text-center">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
      <div className="">
        <h6 className="
            ...
            md:justify-start
          ">
          N4 CONSTRUCTION GROUP LTD.
        </h6>
        <p>
          {/* Building for generation to come. */}
        </p>
      </div>
  ...
  <div className="text-center p-6 bg-gray-200">
    <span>© {date} </span>
    <a className="text-gray-600 font-semibold" href="https://tailwind-elements.com/">N4 Construction Group</a>
  </div>
</footer>
  )
}
